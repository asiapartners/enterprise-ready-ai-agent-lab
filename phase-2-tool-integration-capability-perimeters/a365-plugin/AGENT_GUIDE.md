...
- [../../TEAMS_COPILOT_INTEGRATION.md](../../TEAMS_COPILOT_INTEGRATION.md) — Top-level developer journey: OpenClaw + M365 Agents SDK + Agent 365 → Teams/Copilot (Pattern A vs Pattern B, AI-guided setup, capability tiers)
